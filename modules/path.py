...
temp_outputs_web_path = '../../outputs_web/'
temp_outputs_api_path = '../../outputs_api/'
...
default_negative_prompt = get_config_item_or_set_default(
    key='default_negative_prompt_',
    default_value='low quality, bad hands, bad anatomy, three hands, bad eyes, cropped, bad arms, missing legs, missing arms, poorly drawn face, bad face, fused face, cloned face, worst face, three crus, extra crus, fused crus, worst feet, three feet, fused feet, fused thigh, three thigh, fused thigh, extra thigh, worst thigh, missing fingers, extra fingers, ugly fingers, long fingers, horn, extra eyes, huge eyes, extra digit, out of frame, text, error, cropped, worst quality, jpeg artifacts, ugly, duplicate, morbid, mutilated',
    validator=lambda x: isinstance(x, str)
)
